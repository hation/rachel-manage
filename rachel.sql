...
-- ----------------------------
INSERT INTO `rachel_admins` VALUES (1, 'zmx', '11', NULL, NULL);
...
-- ----------------------------
INSERT INTO `rachel_movies` VALUES (7, '流浪地球', 'liulang.jpg', 1, '太阳即将毁灭，人类在地球表面建造出巨大的推进器，寻找新家园。然而宇宙之路危机四伏，为了拯救地球，为了人类能在漫长的2500年后抵达新的家园，流浪地球时代的年轻人挺身而出，展开争分夺秒的生死之战。', '2019-01-05 00:00:00', 122, '2019-03-19 12:57:09');
INSERT INTO `rachel_movies` VALUES (8, '疯狂的外星人', 'fengkuang.jpg', 1, '号称银河系最先进的外星文明试图和地球建交，谁知一连串的误会导致意外发生。外星使者的飞船坠入大气层，最终摔在了中国某市的世界公园中。靠耍猴戏为生的耿浩（黄渤 饰）和酒贩子好友大飞（沈腾 饰）把受伤的外星人错认为来自南美洲的猴子，在自家猴子受伤的情况下，耿浩开始训练起这个他口中的“刚果骚骚猴”来了。由于失去了超能力加成设备，外星人的本事无法施展，只能任由这两个傻乎乎的地球人打骂操练。尽管如此，他仍试图夺回自己的装备。另一方面，之前与外星人交流失败的超级大国根据外星人留下的信息，穿梭世界各地寻找外星使者。地球的命运朝着不可预测的方向发展……', '2019-02-05 00:00:00', 116, '2019-03-19 12:59:45');
INSERT INTO `rachel_movies` VALUES (9, '新喜剧之王', 'xiju.jpg', 1, '大型影视基地，胸怀明星梦的女子如梦（鄂靖文 饰）已经在影视圈摸爬滚打了十多年，却依旧还是籍籍无名的龙套演员。平日里，在片场饱受剧组和其他演员的欺凌嘲笑，回到家则被恨铁不成钢的老爹指责，甚至扬言断绝父女关系。然而如梦一律微笑面对，天大的委屈也藏在心中，死皮赖脸地抓住每一个希望渺茫的机会。在此期间，她结识了热衷于跑龙套的李洋，早已过气却自视甚高的童星马可（王宝强 饰），更彻彻底底看清了自己以及爱情的真相。 \r\n　　她是过于平凡的小人物，是一个不该有梦的女孩，是一个直到宇宙灭亡也永远不会得到演戏机会的可悲龙套……', '2019-02-05 00:00:00', 91, '2019-03-19 13:01:44');
INSERT INTO `rachel_movies` VALUES (10, '阿丽塔：战斗天使', 'alita.jpg', 1, '故事发生在遥远的26世纪，外科医生依德（克里斯托弗·瓦尔兹 Christoph Waltz 饰）在垃圾场里捡到了只剩下头部的机械少女将她带回家中，给她装上了本来为自己已故的女儿所准备的义体，并取名阿丽塔（罗莎·萨拉扎尔 Rosa Salazar 饰）。苏醒后的阿丽塔对这个五彩斑斓但却暴力而又残酷的世界产生了浓厚的兴趣，在结识了青年雨果（基恩·约翰逊 Keean Johnson 饰）后，阿丽塔开始接触名为机动球的运动，并在比赛中展现出了惊人的格斗天赋。 ', '2019-02-22 00:00:00', 122, '2019-03-19 13:03:33');
INSERT INTO `rachel_movies` VALUES (11, '惊奇队长', 'jingqi.jpg', 1, '卡罗尔·丹弗斯（布丽·拉尔森 饰）是克里人的精英部队一员，但她挣扎着回忆过去，对于怎么获得超能力、以及之前的人生等超能力之前的人生，她只在梦中有片段不成章的记忆，这层困扰引起的情绪波动也进而影响她对超能力的掌控。所幸，在星际战队指挥官（裘德·洛 饰）的调教之下，卡罗尔·丹弗斯学会如何控制自己的超能力', '2019-03-08 00:00:00', 124, '2019-03-19 13:05:04');
INSERT INTO `rachel_movies` VALUES (12, '比悲伤更悲伤的故事', 'beishang.jpg', 1, '唱片制作人张哲凯（刘以豪 饰）和王牌作词人宋媛媛（陈意涵 饰）相依为命，两人自幼身世坎坷只有彼此为伴，他们是亲人、是朋友，也彷佛是命中注定的另一半。父亲罹患遗传重症而被母亲抛弃的哲凯，深怕自己随时会发病不久人世，始终没有跨出友谊的界线对媛媛展露爱意。眼见哲凯的病情加重，他暗自决定用剩余的生命完成他们之间的终曲，再为媛媛找个可以托付一生的好男人', '2019-03-01 00:00:00', 130, '2019-03-19 13:06:37');
INSERT INTO `rachel_movies` VALUES (13, '绿皮书', 'lvpishu.jpg', 1, '一名黑人钢琴家，为前往种族歧视严重的南方巡演，找了一个粗暴的白人混混做司机。在一路开车南下的过程里，截然不同的两人矛盾不断，引发了不少争吵和笑料。但又在彼此最需要的时候，一起共渡难关。行程临近结束，两人也慢慢放下了偏见...... 绿皮书，是一本专为黑人而设的旅行指南，标注了各城市中允许黑人进入的旅店、餐馆。电影由真实故事改编。', '2019-03-14 00:00:00', 107, '2019-03-19 13:08:18');
...
-- ----------------------------
INSERT INTO `rachel_users` VALUES (1, 'zmx', '11', '11', 'default0.jpg', '4920', '2019-03-20 22:55:02', '111111', 1);
