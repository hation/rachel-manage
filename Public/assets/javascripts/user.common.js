...
function regCheck() {
    ...
    $('.regButton>button').hover(function () {
        $(this).attr('className', 'regBtn_over')
    }, function () {
        $(this).attr('className', 'regBtn')
    });
...
function regLogin() {
    ...
    $('.regButton>button').hover(function () {
        $(this).attr('className', 'loginBtn_over')
    }, function () {
        $(this).attr('className', 'loginBtn')
    });
...
function forgetLogin() {
    ...
    $('.regButton>button').hover(function () {
        $(this).attr('className', 'forgetBtn_over')
    }, function () {
        $(this).attr('className', 'forgetBtn')
    });
}
